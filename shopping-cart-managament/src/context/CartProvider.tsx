...
const reducer = (state: CartStateType, action : ReducerAction):CartStateType => {
    switch(action.type) {
        ...
        case REDUCER_ACTION_TYPE.QUANTİTY: {
            if(!action.payload) {
            ...
            const uptadedItem : CartItemType = {...itemExist, qty}
            const filteredCart: CartItemType[] = state.cart.filter(item => item.sku !== sku);

            return {...state, cart: [...filteredCart, uptadedItem]}
        }
        case REDUCER_ACTION_TYPE.SUBMİT: {
            return {...state, cart:[]}
        }
